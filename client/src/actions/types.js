...
export const FETCH_POPULAR_ANIME_LIST_START = 'fetch_popular_anime_list_start';
export const FETCH_POPULAR_ANIME_LIST_SUCCESS = 'fetch_popular_anime_list_success';
